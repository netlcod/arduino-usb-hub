...
# generic_5btn: Arduino Mouse layout with 5 buttons and 16-bit X/Y
# (16-bit axes, like the G305 source). Differences from the 3-button
# reference: USAGE_MAXIMUM 05 (0x29 0x05), REPORT_COUNT 05 (0x95 0x05),
# padding shrinks to 3 bits (0x75 0x03), X/Y gain LogicalMin/Max
# 16-bit range and ReportSize 16 / ReportCount 2, wheel becomes a
# single 8-bit field.
GENERIC_5BTN_DESCRIPTOR = bytes([
    ...
    0x05, 0x01, 0x09, 0x38, 0x15, 0x81, 0x25, 0x7f, 0x75, 0x08, 0x95, 0x01,
    0x81, 0x06,
    0xc0, 0xc0,
])
